...
exports.registerAlertsRoutes = registerAlertsRoutes;
function registerAlertsRoutes(app) {
    app.get('/api/alerts/active', { preHandler: app.auth.requireApiKey('ADMIN') }, async () => {
